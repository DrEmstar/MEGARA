function [Ypk,Xpk,Wpk,Ppk,bPk,iLB,iRB] = findpeaks_vsini(Yin,varargin)
...
if needWidth
  ...
  % (wxPk)
  [iPk,bPk,bxPk,byPk,wxPk,iLB,iRB] = findExtents(y,x,iPk,iFinite,iInfinite,iInflect,minP,minW,maxW,refW);
else
...
%--------------------------------------------------------------------------
function [iPk,bPk,bxPk,byPk,wxPk,iLB,iRB] = findExtents(y,x,iPk,iFin,iInf,iInflect,minP,minW,maxW,refW)
